...
module.exports.setRouter = (app) => {
  ...
  app.post(
    `${baseUrl}/addMeeting`,
    auth.isAuthorized,
    meetingController.addMeetingFunction
  );
  /**
     * @apiGroup Meetings
     * @apiVersion  1.0.0
  ...
  // params: meetingId.
  app.put(
    `${baseUrl}/:meetingId/updateMeeting`,
    auth.isAuthorized,
    meetingController.updateMeetingFunction
  );
  /**
     * @apiGroup Meetings
     * @apiVersion  1.0.0
  ...
  // params: meetingId.
  app.post(
    `${baseUrl}/:meetingId/delete`,
    auth.isAuthorized,
    meetingController.deleteMeetingFunction
  );
  ...
  app.get(
    `${baseUrl}/view/all/meetings/:userId`,
    auth.isAuthorized,
    meetingController.getAllMeetingsFunction
  );
  /**
     * @apiGroup Meetings
     * @apiVersion  1.0.0
  ...
  // params: meetingId.
  app.get(
    `${baseUrl}/:meetingId/details`,
    auth.isAuthorized,
    meetingController.getMeetingDetailsFunction
  );
  /**
     * @apiGroup Meetings
     * @apiVersion  1.0.0
  ...
  // params: meetingId.
  app.post(
    `${baseUrl}/admin-meetings/sentReminders`,
    auth.isAuthorized,
    meetingController.sendReminderForTodaysMeetings
  );
  /**
     * @apiGroup Meetings
     * @apiVersion  1.0.0
